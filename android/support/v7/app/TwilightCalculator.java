...
class TwilightCalculator {
  ...
  public void calculateTwilight(long paramLong, double paramDouble1, double paramDouble2) {
    ...
    Double.isNaN(d1);
    d1 = 1.796593063D + d1 + d2 * 0.03341960161924362D + Math.sin((2.0F * f2)) * 3.4906598739326E-4D + Math.sin((3.0F * f2)) * 5.236000106378924E-6D + Math.PI;
    ...
    this.sunset = Math.round((paramDouble1 + paramDouble2) * 8.64E7D) + 946728000000L;
    paramDouble1 = f1;
    Double.isNaN(paramDouble1);
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v7\app\TwilightCalculator.class
