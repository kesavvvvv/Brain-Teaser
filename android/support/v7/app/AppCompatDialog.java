...
public class AppCompatDialog extends Dialog implements AppCompatCallback {
  ...
  private final KeyEventDispatcher.Component mKeyDispatcher = new KeyEventDispatcher.Component() {
      public boolean superDispatchKeyEvent(KeyEvent param1KeyEvent) { return AppCompatDialog.this.superDispatchKeyEvent(param1KeyEvent); }
    };
  
  public AppCompatDialog(Context paramContext) { this(paramContext, 0); }
  ...
  protected AppCompatDialog(Context paramContext, boolean paramBoolean, DialogInterface.OnCancelListener paramOnCancelListener) { super(paramContext, paramBoolean, paramOnCancelListener); }
  ...
  public boolean dispatchKeyEvent(KeyEvent paramKeyEvent) {
    ...
    return KeyEventDispatcher.dispatchKeyEvent(this.mKeyDispatcher, view, this, paramKeyEvent);
  }
  ...
  @Nullable
  public ActionMode onWindowStartingSupportActionMode(ActionMode.Callback paramCallback) { return null; }
  ...
  boolean superDispatchKeyEvent(KeyEvent paramKeyEvent) { return super.dispatchKeyEvent(paramKeyEvent); }
  
  public boolean supportRequestWindowFeature(int paramInt) { return getDelegate().requestWindowFeature(paramInt); }
}


/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v7\app\AppCompatDialog.class
