      ...
      if (inputStream != null)
        try {
          ...
          try {
            ...
            stringBuilder1.append(paramUri);
            Log.e("SuggestionsAdapter", stringBuilder1.toString(), inputStream);
          } 
        }  
      ...
      try {
        ...
        if (list != null) {
          ...
          if (i == 1) {
            ...
            i = resources.getIdentifier((String)list.get(1), (String)list.get(0), stringBuilder2);
          } else {
            stringBuilder2 = new StringBuilder();
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v7\widget\SuggestionsAdapter.class
