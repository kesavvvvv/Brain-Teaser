...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
  ...
  public void addTab(ActionBar.Tab paramTab, int paramInt, boolean paramBoolean) {
    ...
    this.mTabLayout.addView(tabView, paramInt, new LinearLayoutCompat.LayoutParams(0, -1, 1.0F));
    Spinner spinner = this.mTabSpinner;
    if (spinner != null)
  ...
  public void animateToVisibility(int paramInt) {
    ...
    if (paramInt == 0) {
      ...
      viewPropertyAnimator.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimator, paramInt));
  ...
  public void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong) { ((TabView)paramView).getTab().select(); }
  ...
  public void setAllowCollapse(boolean paramBoolean) { this.mAllowCollapse = paramBoolean; }
  ...
  private class TabAdapter extends BaseAdapter {
    public int getCount() { return ScrollingTabContainerView.this.mTabLayout.getChildCount(); }
    
    public Object getItem(int param1Int) { return ((ScrollingTabContainerView.TabView)ScrollingTabContainerView.this.mTabLayout.getChildAt(param1Int)).getTab(); }
    
    public long getItemId(int param1Int) { return param1Int; }
    
    public View getView(int param1Int, View param1View, ViewGroup param1ViewGroup) {
      if (param1View == null)
        return ScrollingTabContainerView.this.createTabView((ActionBar.Tab)getItem(param1Int), true); 
  ...
  private class TabView extends LinearLayout {
    ...
    public ActionBar.Tab getTab() { return this.mTab; }
    ...
    public void update() {
      ...
      if (view != null) {
        charSequence1 = view.getParent();
        if (charSequence1 != this) {
          if (charSequence1 != null)
            ((ViewGroup)charSequence1).removeView(view); 
          addView(view);
        } 
      ...
      boolean bool = TextUtils.isEmpty(charSequence2) ^ true;
      if (bool) {
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v7\widget\ScrollingTabContainerView.class
