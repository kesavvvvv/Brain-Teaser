...
class ThemeUtils {
  ...
  public static int getThemeAttrColor(Context paramContext, int paramInt) {
    null = TEMP_ARRAY;
    null[0] = paramInt;
    tintTypedArray = TintTypedArray.obtainStyledAttributes(paramContext, null, null);
    try {
      return tintTypedArray.getColor(0, 0);
    } finally {
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v7\widget\ThemeUtils.class
