...
public class AppCompatImageHelper {
  ...
  public AppCompatImageHelper(ImageView paramImageView) { this.mView = paramImageView; }
  ...
  public void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt) {
    tintTypedArray = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), paramAttributeSet, R.styleable.AppCompatImageView, paramInt, 0);
    try {
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v7\widget\AppCompatImageHelper.class
