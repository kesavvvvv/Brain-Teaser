...
public class PrecomputedTextCompat implements Spannable {
  ...
  public static final class Params {
    ...
    public boolean equals(@Nullable Object param1Object) {
      ...
      if (param1Object != null) {
        if (!(param1Object instanceof Params))
          return false; 
        param1Object = (Params)param1Object;
        PrecomputedText.Params params = this.mWrapped;
        if (params != null)
          return params.equals(param1Object.mWrapped); 
        if (Build.VERSION.SDK_INT >= 23) {
    ...
    @RequiresApi(23)
    public int getBreakStrategy() { return this.mBreakStrategy; }
    
    @RequiresApi(23)
    public int getHyphenationFrequency() { return this.mHyphenationFrequency; }
    
    @Nullable
    @RequiresApi(18)
    public TextDirectionHeuristic getTextDirection() { return this.mTextDir; }
    
    @NonNull
    public TextPaint getTextPaint() { return this.mPaint; }
    
    public int hashCode() { return (Build.VERSION.SDK_INT >= 24) ? ObjectsCompat.hash(new Object[] { 
    ...
    public static class Builder {
      ...
      @NonNull
      public PrecomputedTextCompat.Params build() { return new PrecomputedTextCompat.Params(this.mPaint, this.mTextDir, this.mBreakStrategy, this.mHyphenationFrequency); }
  ...
  private static class PrecomputedTextFutureTask extends FutureTask<PrecomputedTextCompat> {
    PrecomputedTextFutureTask(@NonNull PrecomputedTextCompat.Params param1Params, @NonNull CharSequence param1CharSequence) { super(new PrecomputedTextCallback(param1Params, param1CharSequence)); }
    
    private static class PrecomputedTextCallback extends Object implements Callable<PrecomputedTextCompat> {
      ...
      public PrecomputedTextCompat call() throws Exception { return PrecomputedTextCompat.create(this.mText, this.mParams); }
    }
  }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\text\PrecomputedTextCompat.class
