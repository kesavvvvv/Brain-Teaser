...
public final class DrawableCompat {
  ...
  public static boolean canApplyTheme(@NonNull Drawable paramDrawable) { return (Build.VERSION.SDK_INT >= 21) ? paramDrawable.canApplyTheme() : 0; }
  ...
  public static int getAlpha(@NonNull Drawable paramDrawable) { return (Build.VERSION.SDK_INT >= 19) ? paramDrawable.getAlpha() : 0; }
  
  public static ColorFilter getColorFilter(@NonNull Drawable paramDrawable) { return (Build.VERSION.SDK_INT >= 21) ? paramDrawable.getColorFilter() : null; }
  ...
  public static boolean isAutoMirrored(@NonNull Drawable paramDrawable) { return (Build.VERSION.SDK_INT >= 19) ? paramDrawable.isAutoMirrored() : 0; }
  
  @Deprecated
  public static void jumpToCurrentState(@NonNull Drawable paramDrawable) { paramDrawable.jumpToCurrentState(); }
  ...
  public static <T extends Drawable> T unwrap(@NonNull Drawable paramDrawable) { return (paramDrawable instanceof WrappedDrawable) ? (T)((WrappedDrawable)paramDrawable).getWrappedDrawable() : (T)paramDrawable; }
  
  public static Drawable wrap(@NonNull Drawable paramDrawable) { return (Build.VERSION.SDK_INT >= 23) ? paramDrawable : ((Build.VERSION.SDK_INT >= 21) ? (!(paramDrawable instanceof TintAwareDrawable) ? new WrappedDrawableApi21(paramDrawable) : paramDrawable) : (!(paramDrawable instanceof TintAwareDrawable) ? new WrappedDrawableApi14(paramDrawable) : paramDrawable)); }
}


/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\graphics\drawable\DrawableCompat.class
