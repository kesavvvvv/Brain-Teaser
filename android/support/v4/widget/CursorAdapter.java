...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient {
  ...
  @Deprecated
  public CursorAdapter(Context paramContext, Cursor paramCursor) { init(paramContext, paramCursor, 1); }
  
  public CursorAdapter(Context paramContext, Cursor paramCursor, int paramInt) { init(paramContext, paramCursor, paramInt); }
  ...
  public CharSequence convertToString(Cursor paramCursor) { return (paramCursor == null) ? "" : paramCursor.toString(); }
  ...
  public Cursor getCursor() { return this.mCursor; }
  ...
  public View newDropDownView(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup) { return newView(paramContext, paramCursor, paramViewGroup); }
  ...
  public void setFilterQueryProvider(FilterQueryProvider paramFilterQueryProvider) { this.mFilterQueryProvider = paramFilterQueryProvider; }
  ...
  private class ChangeObserver extends ContentObserver {
    ...
    public void onChange(boolean param1Boolean) { CursorAdapter.this.onContentChanged(); }
  }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\widget\CursorAdapter.class
