...
public abstract class ResourceCursorAdapter extends CursorAdapter {
  ...
  public View newDropDownView(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup) { return this.mInflater.inflate(this.mDropDownLayout, paramViewGroup, false); }
  ...
  public void setDropDownViewResource(int paramInt) { this.mDropDownLayout = paramInt; }
  
  public void setViewResource(int paramInt) { this.mLayout = paramInt; }
}


/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\widget\ResourceCursorAdapter.class
