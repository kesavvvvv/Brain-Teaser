...
public class CircularProgressDrawable extends Drawable implements Animatable {
  ...
  private void setupAnimators() {
    ...
    valueAnimator.addListener(new Animator.AnimatorListener() {
          ...
          public void onAnimationStart(Animator param1Animator) { CircularProgressDrawable.this.mRotationCount = 0.0F; }
        });
  ...
  void applyTransformation(float paramFloat, Ring paramRing, boolean paramBoolean) {
    ...
    if (paramFloat != 1.0F || paramBoolean) {
      ...
      if (paramFloat < 0.5F) {
        ...
        float f = MATERIAL_INTERPOLATOR.getInterpolation(f1);
        f1 = f2;
        f2 = f * 0.79F + 0.01F + f2;
      } else {
  ...
  private static class Ring {
    ...
    int getAlpha() { return this.mAlpha; }
    
    float getArrowHeight() { return this.mArrowHeight; }
    
    float getArrowScale() { return this.mArrowScale; }
    
    float getArrowWidth() { return this.mArrowWidth; }
    
    int getBackgroundColor() { return this.mCirclePaint.getColor(); }
    
    float getCenterRadius() { return this.mRingCenterRadius; }
    
    int[] getColors() { return this.mColors; }
    
    float getEndTrim() { return this.mEndTrim; }
    
    int getNextColor() { return this.mColors[getNextColorIndex()]; }
    
    int getNextColorIndex() { return (this.mColorIndex + 1) % this.mColors.length; }
    
    float getRotation() { return this.mRotation; }
    
    boolean getShowArrow() { return this.mShowArrow; }
    
    float getStartTrim() { return this.mStartTrim; }
    
    int getStartingColor() { return this.mColors[this.mColorIndex]; }
    
    float getStartingEndTrim() { return this.mStartingEndTrim; }
    
    float getStartingRotation() { return this.mStartingRotation; }
    
    float getStartingStartTrim() { return this.mStartingStartTrim; }
    
    Paint.Cap getStrokeCap() { return this.mPaint.getStrokeCap(); }
    
    float getStrokeWidth() { return this.mStrokeWidth; }
    
    void goToNextColor() { setColorIndex(getNextColorIndex()); }
    ...
    void setAlpha(int param1Int) { this.mAlpha = param1Int; }
    ...
    void setBackgroundColor(int param1Int) { this.mCirclePaint.setColor(param1Int); }
    
    void setCenterRadius(float param1Float) { this.mRingCenterRadius = param1Float; }
    
    void setColor(int param1Int) { this.mCurrentColor = param1Int; }
    
    void setColorFilter(ColorFilter param1ColorFilter) { this.mPaint.setColorFilter(param1ColorFilter); }
    ...
    void setEndTrim(float param1Float) { this.mEndTrim = param1Float; }
    
    void setRotation(float param1Float) { this.mRotation = param1Float; }
    ...
    void setStartTrim(float param1Float) { this.mStartTrim = param1Float; }
    
    void setStrokeCap(Paint.Cap param1Cap) { this.mPaint.setStrokeCap(param1Cap); }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\widget\CircularProgressDrawable.class
