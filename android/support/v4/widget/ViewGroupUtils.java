...
public class ViewGroupUtils {
  ...
  static void offsetDescendantRect(ViewGroup paramViewGroup, View paramView, Rect paramRect) {
    ...
    offsetDescendantMatrix(paramViewGroup, paramView, matrix);
    RectF rectF2 = (RectF)sRectF.get();
    RectF rectF1 = rectF2;
    if (rectF2 == null) {
      rectF1 = new RectF();
      sRectF.set(rectF1);
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\widget\ViewGroupUtils.class
