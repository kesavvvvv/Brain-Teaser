...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
  ...
  private final Animation mAnimateToStartPosition = new Animation() {
      public void applyTransformation(float param1Float, Transformation param1Transformation) { SwipeRefreshLayout.this.moveToStart(param1Float); }
    };
  ...
  private void moveSpinner(float paramFloat) {
    ...
    d1 = (f4 / 4.0F);
    double d2 = Math.pow((f4 / 4.0F), 2.0D);
    Double.isNaN(d1);
    f4 = (float)(d1 - d2) * 2.0F;
  ...
  private void startScaleUpAnimation(Animation.AnimationListener paramAnimationListener) {
    ...
    this.mScaleAnimation = new Animation() {
        public void applyTransformation(float param1Float, Transformation param1Transformation) { SwipeRefreshLayout.this.setAnimationProgress(param1Float); }
      };
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    circleImageView.layout(paramInt4 - i, j, paramInt1 / 2 + paramInt2 / 2, j + paramInt3);
  }
  ...
  void startScaleDownAnimation(Animation.AnimationListener paramAnimationListener) {
    this.mScaleDownAnimation = new Animation() {
        public void applyTransformation(float param1Float, Transformation param1Transformation) { SwipeRefreshLayout.this.setAnimationProgress(1.0F - param1Float); }
      };
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\widget\SwipeRefreshLayout.class
