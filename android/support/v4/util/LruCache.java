...
public class LruCache<K, V> extends Object {
  ...
  @Nullable
  protected V create(@NonNull K paramK) { return null; }
  
  public final int createCount() { // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
  ...
  public final int evictionCount() { // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
  ...
  @Nullable
  public final V get(@NonNull K paramK) { // Byte code:
    //   0: aload_1
    //   1: ifnull -> 151
    //   4: aload_0
    //   5: monitorenter
  ...
  public final int hitCount() { // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
  ...
  public final int maxSize() { // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
  ...
  public final int missCount() { // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
  ...
  @Nullable
  public final V put(@NonNull K paramK, @NonNull V paramV) { // Byte code:
    //   0: aload_1
    //   1: ifnull -> 93
    //   4: aload_2
    //   5: ifnull -> 93
  ...
  public final int putCount() { // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
  ...
  @Nullable
  public final V remove(@NonNull K paramK) { // Byte code:
    //   0: aload_1
    //   1: ifnull -> 59
    //   4: aload_0
    //   5: monitorenter
  ...
  public void resize(int paramInt) { // Byte code:
    //   0: iload_1
    //   1: ifle -> 24
    //   4: aload_0
    //   5: monitorenter
  ...
  public final int size() { // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield size : I
  ...
  protected int sizeOf(@NonNull K paramK, @NonNull V paramV) { return 1; }
  
  public final Map<K, V> snapshot() { // Byte code:
    //   0: aload_0
    //   1: monitorenter
  ...
  public void trimToSize(int paramInt) { // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield size : I
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v\\util\LruCache.class
