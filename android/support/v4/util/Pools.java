...
public final class Pools {
  ...
  public static class SimplePool<T> extends Object implements Pool<T> {
  ...
  public static class SynchronizedPool<T> extends SimplePool<T> {
    ...
    public SynchronizedPool(int param1Int) { super(param1Int); }
    
    public T acquire() {
      synchronized (this.mLock) {
        Object object = super.acquire();
        return (T)object;
      } 
    }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v\\util\Pools.class
