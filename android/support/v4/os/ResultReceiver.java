...
public class ResultReceiver implements Parcelable {
  public static final Parcelable.Creator<ResultReceiver> CREATOR = new Parcelable.Creator<ResultReceiver>() {
      public ResultReceiver createFromParcel(Parcel param1Parcel) { return new ResultReceiver(param1Parcel); }
      
      public ResultReceiver[] newArray(int param1Int) { return new ResultReceiver[param1Int]; }
    };
  ...
  public ResultReceiver(Handler paramHandler) { this.mHandler = paramHandler; }
  ...
  class MyResultReceiver extends IResultReceiver.Stub {
    public void send(int param1Int, Bundle param1Bundle) {
      if (ResultReceiver.this.mHandler != null) {
        ResultReceiver.this.mHandler.post(new ResultReceiver.MyRunnable(ResultReceiver.this, param1Int, param1Bundle));
        return;
      } 
  ...
  class MyRunnable implements Runnable {
    ...
    public void run() { ResultReceiver.this.onReceiveResult(this.mResultCode, this.mResultData); }
  }
}


/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\os\ResultReceiver.class
