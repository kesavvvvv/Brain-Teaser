...
public final class LocaleListCompat {
  ...
  static class LocaleListCompatApi24Impl implements LocaleListInterface {
    ...
    public boolean equals(Object param1Object) { return this.mLocaleList.equals(((LocaleListCompat)param1Object).unwrap()); }
    
    public Locale get(int param1Int) { return this.mLocaleList.get(param1Int); }
    ...
    public Object getLocaleList() { return this.mLocaleList; }
    
    public int hashCode() { return this.mLocaleList.hashCode(); }
    
    @IntRange(from = -1L)
    public int indexOf(Locale param1Locale) { return this.mLocaleList.indexOf(param1Locale); }
    
    public boolean isEmpty() { return this.mLocaleList.isEmpty(); }
    
    public void setLocaleList(@NonNull Locale... param1VarArgs) { this.mLocaleList = new LocaleList(param1VarArgs); }
    
    @IntRange(from = 0L)
    public int size() { return this.mLocaleList.size(); }
    
    public String toLanguageTags() { return this.mLocaleList.toLanguageTags(); }
    
    public String toString() { return this.mLocaleList.toString(); }
  }
  ...
  static class LocaleListCompatBaseImpl implements LocaleListInterface {
    ...
    public void setLocaleList(@NonNull Locale... param1VarArgs) { this.mLocaleList = new LocaleListHelper(param1VarArgs); }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\os\LocaleListCompat.class
