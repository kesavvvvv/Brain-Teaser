...
final class GrowingArrayUtils {
  ...
  public static <T> T[] append(T[] paramArrayOfT, int paramInt, T paramT) {
    ...
    if (paramInt + 1 > paramArrayOfT.length) {
      arrayOfT = (T[])(Object[])Array.newInstance(paramArrayOfT.getClass().getComponentType(), growSize(paramInt));
  ...
  public static int growSize(int paramInt) { return (paramInt <= 4) ? 8 : (paramInt * 2); }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\content\res\GrowingArrayUtils.class
