...
final class GradientColorInflaterCompat {
  ...
  private static ColorStops checkColors(@Nullable ColorStops paramColorStops, @ColorInt int paramInt1, @ColorInt int paramInt2, boolean paramBoolean, @ColorInt int paramInt3) { return (paramColorStops != null) ? paramColorStops : (paramBoolean ? new ColorStops(paramInt1, paramInt3, paramInt2) : new ColorStops(paramInt1, paramInt2)); }
  ...
  static Shader createFromXmlInner(@NonNull Resources paramResources, @NonNull XmlPullParser paramXmlPullParser, @NonNull AttributeSet paramAttributeSet, @Nullable Resources.Theme paramTheme) throws IOException, XmlPullParserException {
    ...
    if (typedArray.equals("gradient")) {
      ...
      switch (i) {
        default:
          return new LinearGradient(f1, f2, f3, f4, colorStops.mColors, colorStops.mOffsets, parseTileMode(n));
        case 2:
          return new SweepGradient(f5, f6, colorStops.mColors, colorStops.mOffsets);
        case 1:
          break;
      } 
      if (f7 > 0.0F)
        return new RadialGradient(f5, f6, f7, colorStops.mColors, colorStops.mOffsets, parseTileMode(n)); 
  ...
  private static ColorStops inflateChildElements(@NonNull Resources paramResources, @NonNull XmlPullParser paramXmlPullParser, @NonNull AttributeSet paramAttributeSet, @Nullable Resources.Theme paramTheme) throws XmlPullParserException, IOException {
    ...
    return (arrayList2.size() > 0) ? new ColorStops(arrayList2, arrayList1) : null;
  }
  ...
  static final class ColorStops {
    ...
    ColorStops(@NonNull List<Integer> param1List1, @NonNull List<Float> param1List2) {
      int i = param1List1.size();
      this.mColors = new int[i];
      this.mOffsets = new float[i];
      for (byte b = 0; b < i; b++) {
        this.mColors[b] = ((Integer)param1List1.get(b)).intValue();
        this.mOffsets[b] = ((Float)param1List2.get(b)).floatValue();
      } 
    }
  }
}
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\content\res\GradientColorInflaterCompat.class
