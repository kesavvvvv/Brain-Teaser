...
public final class ViewPropertyAnimatorCompat {
  ...
  ViewPropertyAnimatorCompat(View paramView) { this.mView = new WeakReference(paramView); }
  ...
  private void setListenerInternal(final View view, final ViewPropertyAnimatorListener listener) {
    if (paramViewPropertyAnimatorListener != null) {
      paramView.animate().setListener(new AnimatorListenerAdapter() {
            public void onAnimationCancel(Animator param1Animator) { listener.onAnimationCancel(view); }
            
            public void onAnimationEnd(Animator param1Animator) { listener.onAnimationEnd(view); }
            
            public void onAnimationStart(Animator param1Animator) { listener.onAnimationStart(view); }
          });
      return;
    } 
    ...
    if (view != null && Build.VERSION.SDK_INT >= 19) {
      ...
      if (paramViewPropertyAnimatorUpdateListener != null)
        animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator param1ValueAnimator) { listener.onAnimationUpdate(view); }
          }; 
  ...
  static class ViewPropertyAnimatorListenerApi14 implements ViewPropertyAnimatorListener {
    ...
    ViewPropertyAnimatorListenerApi14(ViewPropertyAnimatorCompat param1ViewPropertyAnimatorCompat) { this.mVpa = param1ViewPropertyAnimatorCompat; }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\view\ViewPropertyAnimatorCompat.class
