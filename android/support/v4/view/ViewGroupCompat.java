...
public final class ViewGroupCompat {
  ...
  public static int getLayoutMode(@NonNull ViewGroup paramViewGroup) { return (Build.VERSION.SDK_INT >= 18) ? paramViewGroup.getLayoutMode() : 0; }
  
  public static int getNestedScrollAxes(@NonNull ViewGroup paramViewGroup) { return (Build.VERSION.SDK_INT >= 21) ? paramViewGroup.getNestedScrollAxes() : ((paramViewGroup instanceof NestedScrollingParent) ? ((NestedScrollingParent)paramViewGroup).getNestedScrollAxes() : 0); }
  ...
  public static boolean isTransitionGroup(@NonNull ViewGroup paramViewGroup) {
    ...
    return ((bool != null && bool.booleanValue()) || paramViewGroup.getBackground() != null || ViewCompat.getTransitionName(paramViewGroup) != null);
  }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\view\ViewGroupCompat.class
