...
public class PagerTabStrip extends PagerTitleStrip {
  ...
  public PagerTabStrip(@NonNull Context paramContext) { this(paramContext, null); }
  ...
  public PagerTabStrip(@NonNull Context paramContext, @Nullable AttributeSet paramAttributeSet) {
    ...
    this.mPrevText.setOnClickListener(new View.OnClickListener() {
          public void onClick(View param1View) { PagerTabStrip.this.mPager.setCurrentItem(PagerTabStrip.this.mPager.getCurrentItem() - 1); }
        });
  ...
  public boolean getDrawFullUnderline() { return this.mDrawFullUnderline; }
  
  int getMinHeight() { return Math.max(super.getMinHeight(), this.mMinStripHeight); }
  
  @ColorInt
  public int getTabIndicatorColor() { return this.mIndicatorColor; }
  ...
  public void setTabIndicatorColorResource(@ColorRes int paramInt) { setTabIndicatorColor(ContextCompat.getColor(getContext(), paramInt)); }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\view\PagerTabStrip.class
