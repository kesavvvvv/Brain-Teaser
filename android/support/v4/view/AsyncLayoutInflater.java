...
public final class AsyncLayoutInflater {
  ...
  private static class BasicInflater extends LayoutInflater {
    ...
    BasicInflater(Context param1Context) { super(param1Context); }
    
    public LayoutInflater cloneInContext(Context param1Context) { return new BasicInflater(param1Context); }
  ...
  private static class InflateThread extends Thread {
    ...
    public void enqueue(AsyncLayoutInflater.InflateRequest param1InflateRequest) {
      try {
        ...
        return;
      } catch (InterruptedException param1InflateRequest) {
        throw new RuntimeException("Failed to enqueue async inflate request", param1InflateRequest);
      } 
    }
    ...
    public void runInner() {
      try {
        AsyncLayoutInflater.InflateRequest inflateRequest = (AsyncLayoutInflater.InflateRequest)this.mQueue.take();
        try {
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\view\AsyncLayoutInflater.class
