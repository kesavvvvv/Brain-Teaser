...
public abstract class ActionProvider {
  ...
  public ActionProvider(Context paramContext) { this.mContext = paramContext; }
  ...
  public View onCreateActionView(MenuItem paramMenuItem) { return onCreateActionView(); }
  ...
  @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
  public void setSubUiVisibilityListener(SubUiVisibilityListener paramSubUiVisibilityListener) { this.mSubUiVisibilityListener = paramSubUiVisibilityListener; }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\view\ActionProvider.class
