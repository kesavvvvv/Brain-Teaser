...
public class FrameMetricsAggregator {
  ...
  public FrameMetricsAggregator() { this(1); }
  ...
  public void add(@NonNull Activity paramActivity) { this.mInstance.add(paramActivity); }
  
  @Nullable
  public SparseIntArray[] getMetrics() { return this.mInstance.getMetrics(); }
  
  @Nullable
  public SparseIntArray[] remove(@NonNull Activity paramActivity) { return this.mInstance.remove(paramActivity); }
  
  @Nullable
  public SparseIntArray[] reset() { return this.mInstance.reset(); }
  
  @Nullable
  public SparseIntArray[] stop() { return this.mInstance.stop(); }
  ...
  private static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
    ...
    Window.OnFrameMetricsAvailableListener mListener = new Window.OnFrameMetricsAvailableListener() {
        public void onFrameMetricsAvailable(Window param2Window, FrameMetrics param2FrameMetrics, int param2Int) {
          if ((FrameMetricsAggregator.FrameMetricsApi24Impl.this.mTrackingFlags & true) != 0) {
    ...
    FrameMetricsApi24Impl(int param1Int) { this.mTrackingFlags = param1Int; }
    ...
    public void add(Activity param1Activity) {
      ...
      for (byte b = 0; b <= 8; b++) {
        ...
        if (arrayOfSparseIntArray[b] == null && (this.mTrackingFlags & true << b) != 0)
    ...
    public SparseIntArray[] getMetrics() { return this.mMetrics; }
    
    public SparseIntArray[] remove(Activity param1Activity) {
      for (WeakReference weakReference : this.mActivities) {
    ...
    public SparseIntArray[] stop() {
      for (int i = this.mActivities.size() - 1; i >= 0; i--) {
        WeakReference weakReference = (WeakReference)this.mActivities.get(i);
  ...
  class null implements Window.OnFrameMetricsAvailableListener {
    ...
    public void onFrameMetricsAvailable(Window param1Window, FrameMetrics param1FrameMetrics, int param1Int) {
      if ((this.this$0.mTrackingFlags & true) != 0) {
  ...
  private static class FrameMetricsBaseImpl {
    ...
    public SparseIntArray[] getMetrics() { return null; }
    
    public SparseIntArray[] remove(Activity param1Activity) { return null; }
    
    public SparseIntArray[] reset() { return null; }
    
    public SparseIntArray[] stop() { return null; }
  }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\app\FrameMetricsAggregator.class
