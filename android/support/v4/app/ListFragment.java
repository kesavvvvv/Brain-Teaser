...
public class ListFragment extends Fragment {
  ...
  private final AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() {
      public void onItemClick(AdapterView<?> param1AdapterView, View param1View, int param1Int, long param1Long) { ListFragment.this.onListItemClick((ListView)param1AdapterView, param1View, param1Int, param1Long); }
    };
  
  View mProgressContainer;
  
  private final Runnable mRequestFocus = new Runnable() {
      public void run() { ListFragment.this.mList.focusableViewAvailable(ListFragment.this.mList); }
    };
  ...
  public ListAdapter getListAdapter() { return this.mAdapter; }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
    ...
    frameLayout1.addView(linearLayout, new FrameLayout.LayoutParams(-1, -1));
    ...
    frameLayout1.addView(frameLayout2, new FrameLayout.LayoutParams(-1, -1));
    frameLayout1.setLayoutParams(new FrameLayout.LayoutParams(-1, -1));
    return frameLayout1;
  }
  ...
  public void setListShown(boolean paramBoolean) { setListShown(paramBoolean, true); }
  
  public void setListShownNoAnimation(boolean paramBoolean) { setListShown(paramBoolean, false); }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\app\ListFragment.class
