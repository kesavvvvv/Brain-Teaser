...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
  ...
  public ActionBarDrawerToggle(Activity paramActivity, DrawerLayout paramDrawerLayout, @DrawableRes int paramInt1, @StringRes int paramInt2, @StringRes int paramInt3) { this(paramActivity, paramDrawerLayout, assumeMaterial(paramActivity) ^ true, paramInt1, paramInt2, paramInt3); }
  ...
  private static boolean assumeMaterial(Context paramContext) { return ((paramContext.getApplicationInfo()).targetSdkVersion >= 21 && Build.VERSION.SDK_INT >= 21); }
  ...
  private Drawable getThemeUpIndicator() {
    ...
    if (Build.VERSION.SDK_INT >= 18) {
      Activity activity = this.mActivity.getActionBar();
      if (activity != null) {
        Context context = activity.getThemedContext();
      } else {
  ...
  private void setActionBarDescription(int paramInt) {
    ...
    if (this.mSetIndicatorInfo.mSetHomeAsUpIndicator != null)
      try {
        ...
        Log.w("ActionBarDrawerToggle", "Couldn't set content description via JB-MR2 API", delegate);
      }  
  }
  ...
  public void setHomeAsUpIndicator(int paramInt) {
    ...
    if (paramInt != 0)
      drawable = ContextCompat.getDrawable(this.mActivity, paramInt); 
  ...
  private class SlideDrawable extends InsetDrawable implements Drawable.Callback {
    ...
    public float getPosition() { return this.mPosition; }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\app\ActionBarDrawerToggle.class
