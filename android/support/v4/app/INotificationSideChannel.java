...
public interface INotificationSideChannel extends IInterface {
  ...
  public static abstract class Stub extends Binder implements INotificationSideChannel {
    ...
    public Stub() { attachInterface(this, "android.support.v4.app.INotificationSideChannel"); }
    ...
    public boolean onTransact(int param1Int1, Parcel param1Parcel1, Parcel param1Parcel2, int param1Int2) throws RemoteException {
      ...
      if (param1Int1 != 1598968902) {
        ...
        notify(str, param1Int1, str1, param1Parcel1);
        return true;
      } 
    ...
    private static class Proxy implements INotificationSideChannel {
      ...
      public String getInterfaceDescriptor() { return "android.support.v4.app.INotificationSideChannel"; }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\app\INotificationSideChannel.class
