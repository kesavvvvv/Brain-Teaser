...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
  ...
  NotificationCompatBuilder(NotificationCompat.Builder paramBuilder) {
    ...
    if (Build.VERSION.SDK_INT >= 16) {
      ...
      Iterator iterator = paramBuilder.mActions.iterator();
      while (iterator.hasNext())
        addAction((NotificationCompat.Action)iterator.next()); 
    ...
    if (Build.VERSION.SDK_INT >= 21) {
      ...
      if (paramBuilder.mInvisibleActions.size() > 0) {
        ...
        for (byte b = 0; b < paramBuilder.mInvisibleActions.size(); b++)
          bundle2.putBundle(Integer.toString(b), NotificationCompatJellybean.getBundleForAction((NotificationCompat.Action)paramBuilder.mInvisibleActions.get(b))); 
  ...
  private void addAction(NotificationCompat.Action paramAction) {
    if (Build.VERSION.SDK_INT >= 20) {
      ...
      if (paramAction.getRemoteInputs() != null) {
        bundle = RemoteInput.fromCompat(paramAction.getRemoteInputs());
        int i = bundle.length;
        for (byte b = 0; b < i; b++)
          builder.addRemoteInput(bundle[b]); 
      } 
  ...
  public Notification.Builder getBuilder() { return this.mBuilder; }
}


/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\app\NotificationCompatBuilder.class
