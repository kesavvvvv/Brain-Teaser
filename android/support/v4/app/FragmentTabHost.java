...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
  ...
  static class DummyTabFactory implements TabHost.TabContentFactory {
    ...
    public DummyTabFactory(Context param1Context) { this.mContext = param1Context; }
  ...
  static class SavedState extends View.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
        public FragmentTabHost.SavedState createFromParcel(Parcel param2Parcel) { return new FragmentTabHost.SavedState(param2Parcel); }
        
        public FragmentTabHost.SavedState[] newArray(int param2Int) { return new FragmentTabHost.SavedState[param2Int]; }
      };
  ...
  static final class null extends Object implements Parcelable.Creator<SavedState> {
    public FragmentTabHost.SavedState createFromParcel(Parcel param1Parcel) { return new FragmentTabHost.SavedState(param1Parcel); }
    
    public FragmentTabHost.SavedState[] newArray(int param1Int) { return new FragmentTabHost.SavedState[param1Int]; }
  }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\app\FragmentTabHost.class
