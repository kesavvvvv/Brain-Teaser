...
class LoaderManagerImpl extends LoaderManager {
  ...
  public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
    ...
    Loader<D> destroy(boolean param1Boolean) {
      ...
      LoaderManagerImpl.LoaderObserver loaderObserver = this.mObserver;
    ...
    @NonNull
    Loader<D> getLoader() { return this.mLoader; }
    ...
    Loader<D> setCallback(@NonNull LifecycleOwner param1LifecycleOwner, @NonNull LoaderManager.LoaderCallbacks<D> param1LoaderCallbacks) {
      LoaderManagerImpl.LoaderObserver loaderObserver1 = new LoaderManagerImpl.LoaderObserver(this.mLoader, param1LoaderCallbacks);
      observe(param1LifecycleOwner, loaderObserver1);
      LoaderManagerImpl.LoaderObserver loaderObserver2 = this.mObserver;
  ...
  static class LoaderObserver<D> extends Object implements Observer<D> {
    ...
    boolean hasDeliveredData() { return this.mDeliveredData; }
    ...
    public String toString() { return this.mCallback.toString(); }
  }
  
  static class LoaderViewModel extends ViewModel {
    private static final ViewModelProvider.Factory FACTORY = new ViewModelProvider.Factory() {
        @NonNull
        public <T extends ViewModel> T create(@NonNull Class<T> param2Class) { return (T)new LoaderManagerImpl.LoaderViewModel(); }
      };
    ...
    @NonNull
    static LoaderViewModel getInstance(ViewModelStore param1ViewModelStore) { return (LoaderViewModel)(new ViewModelProvider(param1ViewModelStore, FACTORY)).get(LoaderViewModel.class); }
    ...
    public void dump(String param1String, FileDescriptor param1FileDescriptor, PrintWriter param1PrintWriter, String[] param1ArrayOfString) {
      if (this.mLoaders.size() > 0) {
        ...
        byte b;
        for (b = 0; b < this.mLoaders.size(); b++) {
    ...
    void finishCreatingLoader() { this.mCreatingLoader = false; }
    
    <D> LoaderManagerImpl.LoaderInfo<D> getLoader(int param1Int) { return (LoaderManagerImpl.LoaderInfo)this.mLoaders.get(param1Int); }
    ...
    boolean isCreatingLoader() { return this.mCreatingLoader; }
    ...
    void putLoader(int param1Int, @NonNull LoaderManagerImpl.LoaderInfo param1LoaderInfo) { this.mLoaders.put(param1Int, param1LoaderInfo); }
    
    void removeLoader(int param1Int) { this.mLoaders.remove(param1Int); }
    
    void startCreatingLoader() { this.mCreatingLoader = true; }
  }
  
  static final class null implements ViewModelProvider.Factory {
    @NonNull
    public <T extends ViewModel> T create(@NonNull Class<T> param1Class) { return (T)new LoaderManagerImpl.LoaderViewModel(); }
  }
}


/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\app\LoaderManagerImpl.class
