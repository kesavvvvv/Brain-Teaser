  ...
  public boolean areNotificationsEnabled() {
    ...
    if (Build.VERSION.SDK_INT >= 19) {
      ...
      try {
        ...
        return (i == 0);
      } catch (ClassNotFoundException appOpsManager) {
        return true;
      } catch (NoSuchMethodException appOpsManager) {
        return true;
      } catch (NoSuchFieldException appOpsManager) {
        return true;
      } catch (InvocationTargetException appOpsManager) {
        return true;
      } catch (IllegalAccessException appOpsManager) {
        return true;
      } catch (RuntimeException appOpsManager) {
        return true;
      } 
    } 
    return true;
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\app\NotificationManagerCompat.class
