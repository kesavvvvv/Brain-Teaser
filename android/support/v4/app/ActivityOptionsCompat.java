...
public class ActivityOptionsCompat {
  ...
  private static class ActivityOptionsCompatImpl extends ActivityOptionsCompat {
    ...
    ActivityOptionsCompatImpl(ActivityOptions param1ActivityOptions) { this.mActivityOptions = param1ActivityOptions; }
    
    public Rect getLaunchBounds() { return (Build.VERSION.SDK_INT < 24) ? null : this.mActivityOptions.getLaunchBounds(); }
    ...
    public ActivityOptionsCompat setLaunchBounds(@Nullable Rect param1Rect) { return (Build.VERSION.SDK_INT < 24) ? this : new ActivityOptionsCompatImpl(this.mActivityOptions.setLaunchBounds(param1Rect)); }
    
    public Bundle toBundle() { return this.mActivityOptions.toBundle(); }
    ...
    public void update(ActivityOptionsCompat param1ActivityOptionsCompat) {
      if (param1ActivityOptionsCompat instanceof ActivityOptionsCompatImpl) {
        param1ActivityOptionsCompat = (ActivityOptionsCompatImpl)param1ActivityOptionsCompat;
        this.mActivityOptions.update(param1ActivityOptionsCompat.mActivityOptions);
      } 
    }
  }
}
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\app\ActivityOptionsCompat.class
