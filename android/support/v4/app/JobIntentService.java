...
public abstract class JobIntentService extends Service {
  ...
  static WorkEnqueuer getWorkEnqueuer(Context paramContext, ComponentName paramComponentName, boolean paramBoolean, int paramInt) {
    WorkEnqueuer workEnqueuer2 = (WorkEnqueuer)sClassWorkEnqueuer.get(paramComponentName);
    WorkEnqueuer workEnqueuer1 = workEnqueuer2;
    if (workEnqueuer2 == null) {
      CompatWorkEnqueuer compatWorkEnqueuer;
      if (Build.VERSION.SDK_INT >= 26) {
        if (paramBoolean) {
          compatWorkEnqueuer = new JobWorkEnqueuer(paramContext, paramComponentName, paramInt);
        } else {
          throw new IllegalArgumentException("Can't be here without a job id");
        } 
      } else {
        compatWorkEnqueuer = new CompatWorkEnqueuer(compatWorkEnqueuer, paramComponentName);
      } 
  ...
  final class CommandProcessor extends AsyncTask<Void, Void, Void> {
    ...
    protected void onCancelled(Void param1Void) { JobIntentService.this.processorFinished(); }
    
    protected void onPostExecute(Void param1Void) { JobIntentService.this.processorFinished(); }
  }
  ...
  static final class CompatWorkEnqueuer extends WorkEnqueuer {
    ...
    void enqueueWork(Intent param1Intent) { // Byte code:
    ...
    public void serviceProcessingFinished() { // Byte code:
      //   0: aload_0
      //   1: monitorenter
      //   2: aload_0
    ...
    public void serviceProcessingStarted() { // Byte code:
      //   0: aload_0
      //   1: monitorenter
      //   2: aload_0
      //   3: getfield mServiceProcessing : Z
    ...
    public void serviceStartReceived() { // Byte code:
      //   0: aload_0
      //   1: monitorenter
      //   2: aload_0
      //   3: iconst_0
  ...
  final class CompatWorkItem implements GenericWorkItem {
    ...
    public void complete() { JobIntentService.this.stopSelf(this.mStartId); }
  ...
  static final class JobServiceEngineImpl extends JobServiceEngine implements CompatJobEngine {
    ...
    public IBinder compatGetBinder() { return getBinder(); }
    ...
    final class WrapperWorkItem implements JobIntentService.GenericWorkItem {
      ...
      WrapperWorkItem(JobWorkItem param2JobWorkItem) { this.mJobWork = param2JobWorkItem; }
      ...
      public Intent getIntent() { return this.mJobWork.getIntent(); }
    }
  }
  ...
  final class WrapperWorkItem implements GenericWorkItem {
    ...
    WrapperWorkItem(JobWorkItem param1JobWorkItem) { this.mJobWork = param1JobWorkItem; }
  ...
  static final class JobWorkEnqueuer extends WorkEnqueuer {
    ...
    void enqueueWork(Intent param1Intent) { this.mJobScheduler.enqueue(this.mJobInfo, new JobWorkItem(param1Intent)); }
  }
  ...
  static abstract class WorkEnqueuer {
    ...
    WorkEnqueuer(Context param1Context, ComponentName param1ComponentName) { this.mComponentName = param1ComponentName; }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\app\JobIntentService.class
