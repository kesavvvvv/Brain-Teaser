...
public class NotificationCompat {
  ...
  static Action getActionCompatFromAction(Notification.Action paramAction) {
    ...
    return new Action(paramAction.icon, paramAction.title, paramAction.actionIntent, paramAction.getExtras(), remoteInput, null, bool1, i, bool2);
  }
  ...
  public static class Action {
    ...
    public Action(int param1Int, CharSequence param1CharSequence, PendingIntent param1PendingIntent) { this(param1Int, param1CharSequence, param1PendingIntent, new Bundle(), null, null, true, 0, true); }
    ...
    public int getSemanticAction() { return this.mSemanticAction; }
    
    public boolean getShowsUserInterface() { return this.mShowsUserInterface; }
    ...
    public static final class Builder {
      ...
      public Builder(int param2Int, CharSequence param2CharSequence, PendingIntent param2PendingIntent) { this(param2Int, param2CharSequence, param2PendingIntent, new Bundle(), null, true, 0, true); }
      ...
      public Builder(NotificationCompat.Action param2Action) { this(param2Action.icon, param2Action.title, param2Action.actionIntent, new Bundle(param2Action.mExtras), param2Action.getRemoteInputs(), param2Action.getAllowGeneratedReplies(), param2Action.getSemanticAction(), param2Action.mShowsUserInterface); }
      ...
      public NotificationCompat.Action build() {
        ...
        RemoteInput[] arrayOfRemoteInput2 = new ArrayList();
        ...
        if (arrayList != null)
          for (RemoteInput remoteInput : arrayList) {
            ...
            arrayOfRemoteInput2.add(remoteInput);
          }  
        if (arrayOfRemoteInput1.isEmpty()) {
        ...
        if (arrayOfRemoteInput2.isEmpty()) {
          arrayOfRemoteInput2 = null;
        } else {
          arrayOfRemoteInput2 = (RemoteInput[])arrayOfRemoteInput2.toArray(new RemoteInput[arrayOfRemoteInput2.size()]);
        } 
  ...
  public static final class Builder {
    ...
    public Builder(int param1Int, CharSequence param1CharSequence, PendingIntent param1PendingIntent) { this(param1Int, param1CharSequence, param1PendingIntent, new Bundle(), null, true, 0, true); }
    ...
    public Builder(NotificationCompat.Action param1Action) { this(param1Action.icon, param1Action.title, param1Action.actionIntent, new Bundle(param1Action.mExtras), param1Action.getRemoteInputs(), param1Action.getAllowGeneratedReplies(), param1Action.getSemanticAction(), param1Action.mShowsUserInterface); }
  ...
  public static class Builder {
    ...
    @RequiresApi(21)
    public Builder addInvisibleAction(int param1Int, CharSequence param1CharSequence, PendingIntent param1PendingIntent) { return addInvisibleAction(new NotificationCompat.Action(param1Int, param1CharSequence, param1PendingIntent)); }
    ...
    public Builder setLights(@ColorInt int param1Int1, int param1Int2, int param1Int3) {
      ...
      param1Int1 = notification.ledOnMS;
      param1Int2 = 1;
    ...
    public static class UnreadConversation {
      ...
      public static class Builder {
        ...
        public NotificationCompat.CarExtender.UnreadConversation build() {
          ...
          String[] arrayOfString = (String[])list.toArray(new String[list.size()]);
        ...
        if (this.mBuilder.mActions != null) {
          ...
          if (m > 0) {
            ...
            while (true) {
              i = n;
              if (j < m) {
                RemoteViews remoteViews1 = generateActionButton((NotificationCompat.Action)this.mBuilder.mActions.get(j));
  ...
  public static class MessagingStyle extends Style {
    ...
    @Deprecated
    public MessagingStyle(@NonNull CharSequence param1CharSequence) { this.mUser = (new Person.Builder()).setName(param1CharSequence).build(); }
    ...
    public Person getUser() { return this.mUser; }
    
    @Deprecated
    public CharSequence getUserDisplayName() { return this.mUser.getName(); }
    ...
    public static final class Message {
      ...
      @Deprecated
      public Message(CharSequence param2CharSequence1, long param2Long, CharSequence param2CharSequence2) { this(param2CharSequence1, param2Long, (new Person.Builder()).setName(param2CharSequence2).build()); }
      ...
      static Message getMessageFromBundle(Bundle param2Bundle) {
        try {
          if (param2Bundle.containsKey("text")) {
            ...
            Message message = new Message(param2Bundle.getCharSequence("text"), param2Bundle.getLong("time"), person);
      ...
      private Bundle toBundle() {
        ...
        if (person != null) {
          ...
          if (Build.VERSION.SDK_INT >= 28) {
            bundle1.putParcelable("sender_person", this.mPerson.toAndroidPerson());
          } else {
      ...
      @Nullable
      public Person getPerson() { return this.mPerson; }
  ...
  public static final class Message {
    ...
    @Deprecated
    public Message(CharSequence param1CharSequence1, long param1Long, CharSequence param1CharSequence2) { this(param1CharSequence1, param1Long, (new Person.Builder()).setName(param1CharSequence2).build()); }
    ...
    static Message getMessageFromBundle(Bundle param1Bundle) {
      try {
        if (param1Bundle.containsKey("text")) {
          ...
          Message message = new Message(param1Bundle.getCharSequence("text"), param1Bundle.getLong("time"), person);
  ...
  public static abstract class Style {
    ...
    private static float constrain(float param1Float1, float param1Float2, float param1Float3) { return (param1Float1 < param1Float2) ? param1Float2 : ((param1Float1 > param1Float3) ? param1Float3 : param1Float1); }
    ...
    public RemoteViews applyStandardTemplate(boolean param1Boolean1, int param1Int, boolean param1Boolean2) {
      ...
      if (this.mBuilder.mSubText != null && Build.VERSION.SDK_INT >= 16) {
        ...
        remoteViews.setViewVisibility(j, param1Int);
        j = R.id.line3;
        if (bool1) {
          param1Int = i;
        } else {
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\v4\app\NotificationCompat.class
