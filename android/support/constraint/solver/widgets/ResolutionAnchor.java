...
public class ResolutionAnchor extends ResolutionNode {
  ...
  public ResolutionAnchor(ConstraintAnchor paramConstraintAnchor) { this.myAnchor = paramConstraintAnchor; }
  ...
  public float getResolvedValue() { return this.resolvedOffset; }
      ...
      if (resolutionAnchor != null && resolutionAnchor.state == 1) {
        ...
        if (resolutionAnchor != null) {
          ...
          if (resolutionAnchor != null && resolutionAnchor.state == 1) {
            ...
            j = this.myAnchor.getMargin();
            int k = this.opposite.myAnchor.getMargin();
            ...
            if (i != 0) {
              resolutionAnchor = this.opposite;
              resolutionAnchor.resolvedOffset = resolutionAnchor.target.resolvedOffset + k + f2 * f1;
              this.resolvedOffset = this.target.resolvedOffset - j - (1.0F - f1) * f2;
            } else {
              this.resolvedOffset = this.target.resolvedOffset + j + f2 * f1;
              resolutionAnchor = this.opposite;
              resolutionAnchor.resolvedOffset = resolutionAnchor.target.resolvedOffset - k - (1.0F - f1) * f2;
            } 
            didResolve();
      ...
      if (resolutionAnchor != null && resolutionAnchor.state == 1) {
        ...
        if (resolutionAnchor != null) {
          ...
          if (resolutionAnchor != null && resolutionAnchor.state == 1) {
            ...
            ResolutionAnchor resolutionAnchor2 = resolutionAnchor1.target;
            resolutionAnchor1.resolvedTarget = resolutionAnchor2.resolvedTarget;
            resolutionAnchor.resolvedOffset += this.offset;
            resolutionAnchor2.resolvedOffset += resolutionAnchor1.offset;
            didResolve();
            this.opposite.didResolve();
            return;
          } 
  ...
  String sType(int paramInt) { return (paramInt == 1) ? "DIRECT" : ((paramInt == 2) ? "CENTER" : ((paramInt == 3) ? "MATCH" : ((paramInt == 4) ? "CHAIN" : ((paramInt == 5) ? "BARRIER" : "UNCONNECTED")))); }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\constraint\solver\widgets\ResolutionAnchor.class
