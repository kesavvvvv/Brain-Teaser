...
public class Constraints extends ViewGroup {
  ...
  private void init(AttributeSet paramAttributeSet) { Log.v("Constraints", " ################# init"); }
  ...
  protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams paramLayoutParams) { return new ConstraintLayout.LayoutParams(paramLayoutParams); }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\constraint\Constraints.class
