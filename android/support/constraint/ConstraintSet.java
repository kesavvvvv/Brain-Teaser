...
public class ConstraintSet {
  ...
  void applyToInternal(ConstraintLayout paramConstraintLayout) {
    ...
    while (b < i) {
      ...
      if (j != -1) {
        if (this.mConstraints.containsKey(Integer.valueOf(j))) {
          ...
          Constraint constraint = (Constraint)this.mConstraints.get(Integer.valueOf(j));
    ...
    for (Integer integer : hashSet) {
      Constraint constraint = (Constraint)this.mConstraints.get(integer);
      if (constraint.mHelperType != -1 && constraint.mHelperType == 1) {
        ...
        constraint.applyTo(layoutParams);
        paramConstraintLayout.addView(barrier, layoutParams);
      } 
      if (constraint.mIsGuideline) {
        ...
        ConstraintLayout.LayoutParams layoutParams = paramConstraintLayout.generateDefaultLayoutParams();
        constraint.applyTo(layoutParams);
        paramConstraintLayout.addView(guideline, layoutParams);
      } 
    } 
  }
  ...
  public void clear(int paramInt) { this.mConstraints.remove(Integer.valueOf(paramInt)); }
  
  public void clear(int paramInt1, int paramInt2) {
    if (this.mConstraints.containsKey(Integer.valueOf(paramInt1))) {
      Constraint constraint = (Constraint)this.mConstraints.get(Integer.valueOf(paramInt1));
      switch (paramInt2) {
        default:
  ...
  public void clone(Context paramContext, int paramInt) { clone((ConstraintLayout)LayoutInflater.from(paramContext).inflate(paramInt, null)); }
  ...
  public void clone(ConstraintLayout paramConstraintLayout) {
    ...
    while (b < i) {
      ...
      if (j != -1) {
        if (!this.mConstraints.containsKey(Integer.valueOf(j)))
          this.mConstraints.put(Integer.valueOf(j), new Constraint(null)); 
  ...
  public void connect(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    switch (paramInt2) {
      ...
      case 7:
        if (paramInt4 == 7) {
          stringBuilder.endToEnd = paramInt3;
          stringBuilder.endToStart = -1;
          return;
        } 
        if (paramInt4 == 6) {
          stringBuilder.endToStart = paramInt3;
          stringBuilder.endToEnd = -1;
          return;
        } 
        stringBuilder = new StringBuilder();
      ...
      case 6:
        if (paramInt4 == 6) {
          stringBuilder.startToStart = paramInt3;
          stringBuilder.startToEnd = -1;
          return;
        } 
        if (paramInt4 == 7) {
          stringBuilder.startToEnd = paramInt3;
          stringBuilder.startToStart = -1;
          return;
        } 
        stringBuilder = new StringBuilder();
        stringBuilder.append("right to ");
      ...
      case 5:
        if (paramInt4 == 5) {
          stringBuilder.baselineToBaseline = paramInt3;
          stringBuilder.bottomToBottom = -1;
          stringBuilder.bottomToTop = -1;
          stringBuilder.topToTop = -1;
          stringBuilder.topToBottom = -1;
          return;
        } 
        stringBuilder = new StringBuilder();
        stringBuilder.append("right to ");
      ...
      case 4:
        if (paramInt4 == 4) {
          stringBuilder.bottomToBottom = paramInt3;
          stringBuilder.bottomToTop = -1;
          stringBuilder.baselineToBaseline = -1;
          return;
        } 
        if (paramInt4 == 3) {
          stringBuilder.bottomToTop = paramInt3;
          stringBuilder.bottomToBottom = -1;
          stringBuilder.baselineToBaseline = -1;
          return;
        } 
      ...
      case 3:
        if (paramInt4 == 3) {
          stringBuilder.topToTop = paramInt3;
          stringBuilder.topToBottom = -1;
          stringBuilder.baselineToBaseline = -1;
          return;
        } 
        if (paramInt4 == 4) {
          stringBuilder.topToBottom = paramInt3;
          stringBuilder.topToTop = -1;
          stringBuilder.baselineToBaseline = -1;
          return;
        } 
      ...
      case 2:
        if (paramInt4 == 1) {
          stringBuilder.rightToLeft = paramInt3;
          stringBuilder.rightToRight = -1;
          return;
        } 
        if (paramInt4 == 2) {
          stringBuilder.rightToRight = paramInt3;
          stringBuilder.rightToLeft = -1;
          return;
        } 
        stringBuilder = new StringBuilder();
        stringBuilder.append("right to ");
    ...
    if (paramInt4 == 1) {
      stringBuilder.leftToLeft = paramInt3;
      stringBuilder.leftToRight = -1;
      return;
    } 
    if (paramInt4 == 2) {
      stringBuilder.leftToRight = paramInt3;
      stringBuilder.leftToLeft = -1;
      return;
    } 
  ...
  public void connect(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5) {
    ...
    switch (paramInt2) {
      ...
      case 7:
        ...
        stringBuilder.endMargin = paramInt5;
        return;
      case 6:
        if (paramInt4 == 6) {
          stringBuilder.startToStart = paramInt3;
        ...
        stringBuilder.startMargin = paramInt5;
        return;
      case 5:
        if (paramInt4 == 5) {
          stringBuilder.baselineToBaseline = paramInt3;
      ...
      case 4:
        ...
        stringBuilder.bottomMargin = paramInt5;
        return;
      case 3:
        if (paramInt4 == 3) {
          stringBuilder.topToTop = paramInt3;
        ...
        stringBuilder.topMargin = paramInt5;
        return;
      case 2:
        if (paramInt4 == 1) {
          stringBuilder.rightToLeft = paramInt3;
        ...
        stringBuilder.rightMargin = paramInt5;
        return;
      case 1:
        break;
    } 
    ...
    stringBuilder.leftMargin = paramInt5;
  }
  ...
  public void constrainDefaultHeight(int paramInt1, int paramInt2) { (get(paramInt1)).heightDefault = paramInt2; }
  
  public void constrainDefaultWidth(int paramInt1, int paramInt2) { (get(paramInt1)).widthDefault = paramInt2; }
  
  public void constrainHeight(int paramInt1, int paramInt2) { (get(paramInt1)).mHeight = paramInt2; }
  
  public void constrainMaxHeight(int paramInt1, int paramInt2) { (get(paramInt1)).heightMax = paramInt2; }
  
  public void constrainMaxWidth(int paramInt1, int paramInt2) { (get(paramInt1)).widthMax = paramInt2; }
  
  public void constrainMinHeight(int paramInt1, int paramInt2) { (get(paramInt1)).heightMin = paramInt2; }
  
  public void constrainMinWidth(int paramInt1, int paramInt2) { (get(paramInt1)).widthMin = paramInt2; }
  
  public void constrainPercentHeight(int paramInt, float paramFloat) { (get(paramInt)).heightPercent = paramFloat; }
  
  public void constrainPercentWidth(int paramInt, float paramFloat) { (get(paramInt)).widthPercent = paramFloat; }
  
  public void constrainWidth(int paramInt1, int paramInt2) { (get(paramInt1)).mWidth = paramInt2; }
  ...
  public void createHorizontalChain(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt, float[] paramArrayOfFloat, int paramInt5) { createHorizontalChain(paramInt1, paramInt2, paramInt3, paramInt4, paramArrayOfInt, paramArrayOfFloat, paramInt5, 1, 2); }
  
  public void createHorizontalChainRtl(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt, float[] paramArrayOfFloat, int paramInt5) { createHorizontalChain(paramInt1, paramInt2, paramInt3, paramInt4, paramArrayOfInt, paramArrayOfFloat, paramInt5, 6, 7); }
  ...
  public boolean getApplyElevation(int paramInt) { return (get(paramInt)).applyElevation; }
  
  public Constraint getParameters(int paramInt) { return get(paramInt); }
        ...
        if (paramInt != 0) {
          ...
          switch (paramInt) {
            case 2:
              ...
              constraint = fillFromAttributeList(paramContext, Xml.asAttributeSet(xmlResourceParser));
  ...
  public void removeFromHorizontalChain(int paramInt) {
    if (this.mConstraints.containsKey(Integer.valueOf(paramInt))) {
      Constraint constraint = (Constraint)this.mConstraints.get(Integer.valueOf(paramInt));
  ...
  public void setAlpha(int paramInt, float paramFloat) { (get(paramInt)).alpha = paramFloat; }
  
  public void setApplyElevation(int paramInt, boolean paramBoolean) { (get(paramInt)).applyElevation = paramBoolean; }
  
  public void setBarrierType(int paramInt1, int paramInt2) {}
  
  public void setDimensionRatio(int paramInt, String paramString) { (get(paramInt)).dimensionRatio = paramString; }
  ...
  public void setHorizontalBias(int paramInt, float paramFloat) { (get(paramInt)).horizontalBias = paramFloat; }
  
  public void setHorizontalChainStyle(int paramInt1, int paramInt2) { (get(paramInt1)).horizontalChainStyle = paramInt2; }
  
  public void setHorizontalWeight(int paramInt, float paramFloat) { (get(paramInt)).horizontalWeight = paramFloat; }
  ...
  public void setRotation(int paramInt, float paramFloat) { (get(paramInt)).rotation = paramFloat; }
  
  public void setRotationX(int paramInt, float paramFloat) { (get(paramInt)).rotationX = paramFloat; }
  
  public void setRotationY(int paramInt, float paramFloat) { (get(paramInt)).rotationY = paramFloat; }
  
  public void setScaleX(int paramInt, float paramFloat) { (get(paramInt)).scaleX = paramFloat; }
  
  public void setScaleY(int paramInt, float paramFloat) { (get(paramInt)).scaleY = paramFloat; }
  ...
  public void setTransformPivotX(int paramInt, float paramFloat) { (get(paramInt)).transformPivotX = paramFloat; }
  
  public void setTransformPivotY(int paramInt, float paramFloat) { (get(paramInt)).transformPivotY = paramFloat; }
  ...
  public void setTranslationX(int paramInt, float paramFloat) { (get(paramInt)).translationX = paramFloat; }
  
  public void setTranslationY(int paramInt, float paramFloat) { (get(paramInt)).translationY = paramFloat; }
  
  public void setTranslationZ(int paramInt, float paramFloat) { (get(paramInt)).translationZ = paramFloat; }
  
  public void setVerticalBias(int paramInt, float paramFloat) { (get(paramInt)).verticalBias = paramFloat; }
  
  public void setVerticalChainStyle(int paramInt1, int paramInt2) { (get(paramInt1)).verticalChainStyle = paramInt2; }
  
  public void setVerticalWeight(int paramInt, float paramFloat) { (get(paramInt)).verticalWeight = paramFloat; }
  
  public void setVisibility(int paramInt1, int paramInt2) { (get(paramInt1)).visibility = paramInt2; }
  ...
  private static class Constraint {
    ...
    public float transformPivotX = NaNF;
    
    public float transformPivotY = NaNF;
    ...
    private void fillFromConstraints(ConstraintHelper param1ConstraintHelper, int param1Int, Constraints.LayoutParams param1LayoutParams) {
      ...
      if (param1ConstraintHelper instanceof Barrier) {
        this.mHelperType = 1;
        param1ConstraintHelper = (Barrier)param1ConstraintHelper;
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\support\constraint\ConstraintSet.class
