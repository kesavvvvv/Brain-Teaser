...
public class ViewModelProvider {
  ...
  public static class AndroidViewModelFactory extends NewInstanceFactory {
    ...
    public AndroidViewModelFactory(@NonNull Application param1Application) { this.mApplication = param1Application; }
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> param1Class) {
      if (AndroidViewModel.class.isAssignableFrom(param1Class))
        try {
          return (T)(ViewModel)param1Class.getConstructor(new Class[] { Application.class }).newInstance(new Object[] { this.mApplication });
      ...
      return (T)super.create(param1Class);
    }
  }
  ...
  public static class NewInstanceFactory implements Factory {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> param1Class) {
      try {
        return (T)(ViewModel)param1Class.newInstance();
      } catch (InstantiationException instantiationException) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Cannot create an instance of ");
        stringBuilder.append(param1Class);
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\arch\lifecycle\ViewModelProvider.class
