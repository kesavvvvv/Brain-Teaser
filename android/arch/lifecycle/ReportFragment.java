...
public class ReportFragment extends Fragment {
  ...
  static ReportFragment get(Activity paramActivity) { return (ReportFragment)paramActivity.getFragmentManager().findFragmentByTag("android.arch.lifecycle.LifecycleDispatcher.report_fragment_tag"); }
  ...
  void setProcessListener(ActivityInitializationListener paramActivityInitializationListener) { this.mProcessListener = paramActivityInitializationListener; }
...
/* Location:              D:\Apks\New folder\classes-dex2jar.jar!\android\arch\lifecycle\ReportFragment.class
